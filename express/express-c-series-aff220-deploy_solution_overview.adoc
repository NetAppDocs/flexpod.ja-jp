...
image:express-c-series-aff220-deploy_image3.png["FlexPod Express、Datacenter、および Select ソリューション、ターゲット、およびインフラストラクチャコンポーネントを比較した図"]
...
image:express-c-series-aff220-deploy_image4.png["Cisco Nexus 3172P スイッチ、UCS C220 M5 サーバー、および AFF A220 ストレージ接続を示す図"]
