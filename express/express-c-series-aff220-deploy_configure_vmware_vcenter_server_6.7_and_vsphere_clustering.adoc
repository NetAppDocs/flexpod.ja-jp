...
. [OK] をクリックします。
+
image:express-c-series-aff220-deploy_image49.png["クラスター Tiger3 で DRS と vSphere HA が有効になっている新しいクラスターダイアログのスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image50.png["vSphere Web クライアントのスクリーンショット。FlexPod クラスターのアクションメニューで「ホストの追加」が選択されています。"]
