...
image:express-c-series-c190-deploy_image1.png["FlexPod Express と FlexPod Datacenter のポートフォリオオプションとユースケースを示す図"]
...
image:express-c-series-c190-deploy_image2.png["FlexPod Express スイッチ、C220 M5 サーバー、および AFF C190 ストレージ接続を示す図"]
