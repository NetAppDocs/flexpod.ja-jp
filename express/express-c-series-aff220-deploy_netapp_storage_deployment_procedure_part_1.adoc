...
+
image:express-c-series-aff220-deploy_image6.png["2つのHAペアノードとライセンスのSystem Manager ガイド付きセットアップのクラスタ構成フィールドのスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image7.png["OnCommand System Manager のサポートセットアップのスクリーンショット（AutoSupport およびイベント通知フィールドあり）"]
