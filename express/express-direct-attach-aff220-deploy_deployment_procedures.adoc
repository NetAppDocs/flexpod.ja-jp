...
コントローラーの物理的な設置手順については、 https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["AFF A220 のドキュメント"^]を参照してください。
...
+
image:express-direct-attach-aff220-deploy_image7.png["IPv4アドレスブロックの作成ダイアログのスクリーンショット（IPアドレス、サブネット、ゲートウェイ、DNSフィールドを含む）"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["NTPサーバーを10.1.156.4に設定した「NTPサーバーの追加」ダイアログのスクリーンショット"]

. Add NTP Server をクリックします。
. 「 <switch-b-ntp-ip>`` 」または「 <nexus-B-mgmt-ip>` 」と入力し、 [OK] をクリックします。確認の [OK] をクリックします。
+
image:express-direct-attach-aff220-deploy_image9.png["Cisco UCS Manager のNTP設定のスクリーンショット。2つのNTPサーバーがリストされ、タイムゾーンとしてAmerica/New_Yorkが選択されています。"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["アップリンクとアプライアンスストレージの役割が構成された Fabric Interconnect A の Ethernet ポートを示すスクリーンショット"]
...
. [Ethernet Ports] タブで、 [If Role] カラムにポートが正しく設定されていることを確認します。スケーラビリティポートにポート C シリーズサーバが設定されている場合は、そのサーバをクリックしてポート接続を確認します。
+
image:express-direct-attach-aff220-deploy_image11.png["ネットワークおよびアプライアンス ストレージのロールが設定されたFabric Interconnect BのEthernetポートを示すスクリーンショット"]
...
. 次へをクリックします。
+
image:express-direct-attach-aff220-deploy_image12.png["ID 1、名前 vPC-13-Nexus を入力した「ポートチャネルの作成」ダイアログのスクリーンショット"]
...
. [ 共有タイプ ] は [ なし ] のままにします。
+
image:express-direct-attach-aff220-deploy_image13.jpeg["NFS-VLANとVLAN ID 3170が入力されたVLAN作成ダイアログのスクリーンショット"]
...
. [OK] をクリックし、もう一度 [OK] をクリックして VLAN を作成します。
+
image:express-direct-attach-aff220-deploy_image14.png["Cisco UCS Manager の VLAN 名と ID を含む VLAN テーブルを示すスクリーンショット"]
...
. LLDP の送受信機能を有効にします。
+
image:express-direct-attach-aff220-deploy_image15.png["CDP と LLDP の送受信が有効になっている Enable_CDP ネットワーク制御ポリシーを示すスクリーンショット"]
...
. [ 変更を保存して OK ] をクリックします。
+
image:express-direct-attach-aff220-deploy_image16.png["CDPが有効でストレージVLANが選択されているアプライアンスインターフェイス1/3のプロパティのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["アプライアンスインターフェイス1/3のVLAN設定でiSCSI-B、NFS、およびネイティブVLANが選択されているスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Cisco UCS Manager QoS システムクラス設定のスクリーンショット（ベストエフォート MTU を 9216 に設定）"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Blade Package 4.0(1b)B が選択された状態の「パッケージバージョンの変更」ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["MACアドレス 00:25:B5:32:0A:00、サイズ 64 の「MACアドレスブロックの作成」ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["「IQNサフィックスのブロックを作成」ダイアログのスクリーンショット（サフィックス：ucs-host、開始番号：1、サイズ：16）"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["CDP と LLDP が有効になっている「ネットワーク制御ポリシーの作成」ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["「電力制御ポリシーの作成」ダイアログで「No-Power-Cap」と「No Cap」が選択されている状態のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Cisco UCS Manager の「CPU/コア認定の作成」ダイアログのスクリーンショット（Xeon プロセッサアーキテクチャと CPU PID フィールドを含む）"]
...
. 一貫したデバイス名を有効に変更します。
+
image:express-direct-attach-aff220-deploy_image25.png["VM ホスト名と一貫性のあるデバイス命名が有効になっている BIOS ポリシー作成ダイアログのスクリーンショット"]
...
** プロセッサ C7 レポート：無効
+
image:express-direct-attach-aff220-deploy_image26.png["プロセッサ C ステートと C1E が無効になっている BIOS ポリシーの作成プロセッサタブのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["Energy Performance と DRAM Clock Throttling がパフォーマンスに設定された BIOS プロセッサオプションを示すスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image28.png["LV DDR モードをパフォーマンスモードに設定した「BIOS ポリシー RAS メモリの作成」ページのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["User Ack と On Next Boot が選択された Cisco UCS Manager のデフォルトメンテナンスポリシーのスクリーンショット"]
...
. [OK] をクリックします。
+
image:express-direct-attach-aff220-deploy_image30.png["Fabric A 上の vNIC_Template_A の Cisco UCS Manager vNIC テンプレートプロパティのスクリーンショット"]
...
. [OK] をクリックします。
+
image:express-direct-attach-aff220-deploy_image31.png["Cisco UCS Manager vNIC テンプレート B の設定（ファブリック B、MTU 9000、MAC プール B を選択）のスクリーンショット"]
...
. [OK] をクリックします。
+
image:express-direct-attach-aff220-deploy_image32.png["Site_01_iSCSI-A vNIC テンプレートのスクリーンショット（Fabric A、MTU 9000、および MAC Pool A56/64 を選択）"]
...
. [OK] をクリックします。
+
image:express-direct-attach-aff220-deploy_image33.png["Fabric B、MTU 9000 の Cisco UCS Manager vNIC テンプレート Site_01_iSCSI-B 設定のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["vNIC_Template_A と VMware アダプタポリシーを使用した Site-01-vNIC-A の vNIC 変更ダイアログを示すスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["Site-01-iSCSI-A の VLAN および MAC アドレス設定を含む iSCSI vNIC の変更ダイアログのスクリーンショット"]
...
. [Save Changes] をクリックします。
+
image:express-direct-attach-aff220-deploy_image36.png["Site-01-iSCSIBoot LAN接続ポリシーに2つのiSCSI vNICが表示されたスクリーンショット"]
...
+
このVMware ESXi 6.7U1 ISOは https://support.broadcom.com/group/ecx/downloads["Broadcomサポートポータル"^]からダウンロードできます。
...
+
image:express-direct-attach-aff220-deploy_image37.png["HTTP ESXiインストーラーISOリモートファイルとパスで設定されたvMediaマウントダイアログの作成のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["2つのiSCSIブートエントリが設定されたCisco UCS Manager ブートポリシー「Site-01-Fabric-A」のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["サービスプロファイルテンプレートの作成ウィザードのスクリーンショット（名前、更新テンプレート、UUID プールフィールドが表示されています）"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["iSCSI-Boot接続とIQN_Poolが選択された状態でのサービスプロファイルテンプレートのネットワーク設定の作成のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Boot-Fabric-A が選択された状態の「サービスプロファイルテンプレートの作成」サーバブート順序ページのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Infra-SVMターゲットのIQN、エイリアス、および稼働状況が一覧表示されたiscsi showコマンド出力のスクリーンショット"]

. IPv4 Address フィールドに「 iSCSI_LIF_02a 」の IP アドレスを入力します。
+
image:express-direct-attach-aff220-deploy_image43.png["IPv4アドレス192.168.10.62が入力された「iSCSI静的ターゲットの作成」ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["IPv4アドレス192.168.10.61およびLUN ID 0を指定したiSCSI静的ターゲットの作成ダイアログのスクリーンショット"]

. OK をクリックして、 iSCSI 静的ターゲットを追加します。
+
image:express-direct-attach-aff220-deploy_image45.png["iSCSI 静的ターゲット インターフェイスを選択した状態での「iSCSI ブート パラメーターの設定」ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["IPv4アドレスを192.168.20.62に設定したiSCSI静的ターゲットの作成ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["IPv4アドレス192.168.20.61およびLUN ID 0を指定したiSCSI静的ターゲットの作成ダイアログのスクリーンショット"]

. OK をクリックして、 iSCSI 静的ターゲットを追加します。
+
image:express-direct-attach-aff220-deploy_image48.png["「iSCSIブートパラメータの設定」で2つのiSCSIスタティックターゲットインターフェイスが選択されていることを示すスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["デフォルトポリシーを選択した状態での「サービスプロファイルテンプレート保守ポリシーの作成」ステップのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Infra-Pool、Down電源状態、およびデフォルトのファームウェアパッケージが選択された状態の「Create Service Profile Template Server Assignment」のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["VM-Host BIOSとNo-Power-Capが選択された状態の「サービスプロファイルテンプレートの作成」運用ポリシーページのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["プレフィックス Site-01-Infra-0、番号 2、ルート組織を持つ「テンプレートからサービスプロファイルを作成」ダイアログのスクリーンショット"]
...
. Broadcom サポートポータルのダウンロードサイトにログインします： https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^]。
. BroadcomのユーザーIDとパスワードが必要です。VMware vSphere Hypervisor （ESXi）のカスタムISOを探してください。
. ESXi 6.7U1 インストール CD 用の Cisco カスタムイメージをダウンロードします。
...
. Enter キーを押します。
+
image:express-direct-attach-aff220-deploy_image53.png["vmnic0とvmnic1が選択され接続されているESXiネットワークアダプタ画面のスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["VMkernelアダプタと2つの物理アダプタを含むvSwitch0の詳細とトポロジーを示すスクリーンショット"]

. [VMkernel NICs] タブを選択して、設定済みの仮想アダプタを確認します。次の例のようなアダプタが表示されます。
+
image:express-direct-attach-aff220-deploy_image55.png["ESXi VMkernel NICタブに5つのVMkernelアダプタとそのポートグループが一覧表示されているスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["iSCSIソフトウェアアダプタ vmhba64 が選択された ESXi のストレージアダプタタブのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["ポート3260上の4つの動的および静的iSCSIターゲットを示すiSCSI設定ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["新規データストアウィザードで作成タイプとして「マウント NFS データストア」が選択されているスクリーンショット"]
...
.. 次へをクリックします。
+
image:express-direct-attach-aff220-deploy_image59.png["infra_datastore_1 および NFSサーバ 192.168.104.3 を使用した「NFS マウントの詳細を入力」ページのスクリーンショット"]
...
. 完了をクリックします。これで、データストアがデータストアのリストに表示されます。
+
image:express-direct-attach-aff220-deploy_image60.jpeg["infra_datastore_2 が NFS データストアとしてマウントされていることを示す ESXi ストレージデータストアリストのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["NTPが有効になっており、2つのNTPサーバーアドレスが入力された状態の時刻設定の編集ダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["VMware ESXi のシステムスワップ管理ページのスクリーンショット。スワップ設定と設定の編集を表示しています。"]

. 設定の編集をクリックします。データストアのオプションから 'infra_swap' を選択します
+
image:express-direct-attach-aff220-deploy_image63.png["スワップ構成の編集ダイアログのスクリーンショット（infra_swapデータストアが選択された状態で、「保存」ボタンと「キャンセル」ボタンが表示されている）"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["ESXiホストナビゲーターのスクリーンショット（「Get vCenter Server」ボタンがハイライト表示されています）"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["vCenter Server Appliance インストーラーの「展開タイプの選択」ページで「Embedded Platform Services Controller」が選択されているスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["ESXiホストの認証情報を入力したVCenter Server Appliance Installerのアプライアンス展開ターゲットページのスクリーンショット"]

. vCSA に VM 名および vCSA に使用するルートパスワードとして VCSA を入力して、アプライアンス VM を設定します。次へをクリックします。
+
image:express-direct-attach-aff220-deploy_image67.png["vCenter Server Appliance インストーラーの「アプライアンス VM の設定」ページのスクリーンショット（VM 名と root パスワードのフィールドを表示）"]

. 環境に最も適した導入サイズを選択してください。次へをクリックします。
+
image:express-direct-attach-aff220-deploy_image68.png["vCenter Server Appliance インストーラーの「展開サイズの選択」ページで「Tiny」が選択されているスクリーンショット"]

. 「 infra_datastore_1' 」データストアを選択します。次へをクリックします。
+
image:express-direct-attach-aff220-deploy_image69.png["vCenter Server Appliance インストーラーの「データストアの選択」ページのスクリーンショット。3つのデータストアの中に infra_datastore_1 が表示されています。"]
...
.. DNS サーバを入力します。
+
image:express-direct-attach-aff220-deploy_image70.png["静的IPv4の詳細を含むvCenter Server Applianceインストーラーのネットワーク設定構成ページのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["ステージ1のvCenter Serverの導入が成功したことを示すスクリーンショット（「続行」ボタン付き）"]
...
. [OK] をクリックします。
+
image:express-direct-attach-aff220-deploy_image72.png["Express クラスタで DRS と vSphere HA が有効になっている新しいクラスタダイアログのスクリーンショット"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["vSphere Client のアクションメニューで「ホストの追加」が選択されている Express クラスタのスクリーンショット"]
