...
image:express-c-series-aff220-design_image3.png["FlexPod Express ストレージ、スイッチング、およびコンピューティングハードウェアファミリと構成オプションを示す図"]
...
image:express-c-series-aff220-design_image4.png["Cisco Nexus 3172P スイッチ、UCS C220 M5 サーバー、および AFF A220 ストレージ接続を示す図"]
