...
image:express-c-series-c190-design_image1.png["FlexPod Expressの部門別デプロイメントとFlexPod Datacenterのミッションクリティカルなワークロードを比較した図"]
...
image:express-c-series-c190-design_image2.png["FlexPod Express のストレージ、スイッチ、およびサーバーハードウェアオプションを示す図"]
...
image:express-c-series-c190-design_image3.png["FlexPod Express スイッチ、C220 M5 サーバー、および AFF C190 ストレージ接続を示す図"]
