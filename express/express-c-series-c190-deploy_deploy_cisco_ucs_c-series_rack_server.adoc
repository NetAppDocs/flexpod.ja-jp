...
+
image:express-c-series-c190-deploy_image5.png["Cisco サーバーの起動画面で CIMC Setup のために F8 キーを押すよう求めるスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image6.png["Cisco IMC Configuration Utility の NIC プロパティのスクリーンショット（専用 NIC および冗長性なしが選択されている）"]
...
+
image:express-c-series-c190-deploy_image7.png["Cisco Integrated Management Controller BIOS ブート順序設定ページのスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image8.png["KVM-MAPPED-DVD、iSCSI-A、iSCSI-Bが有効になっている「Advanced Boot Order Configuration」のスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image9.png["PCIeスロット1とスロット2のオプションROMが無効になっているCIMC BIOS設定を示すスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image10.png["Cisco Integrated Management Controller アダプタカード MLOM の「一般」タブで「ポートチャネル」のチェックが外れている状態のスクリーンショット"]
...
** アップリンクポートを 3 に設定します。
+
image:express-c-series-c190-deploy_image11.png["VLAN 3439 およびアップリンクポート 1 を使用した iSCSI vNIC eth1 の一般設定を示すスクリーンショット"]



. 左側の vNIC eth1 を選択します。
+
image:express-c-series-c190-deploy_image12.png["vNIC eth1 の iSCSI ブートプロパティのイニシエータ設定を示すスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image13.png["イニシエータ、プライマリターゲット、セカンダリターゲットの詳細を含む iSCSI ブートプロパティのスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image14.png["イニシエータとターゲット設定を含むvNIC eth3のiSCSIブートプロパティを示すスクリーンショット"]
...
+
image:express-c-series-c190-deploy_image15.png["MTU 9000 およびデフォルト VLAN 2 が設定された Cisco Integrated Management Controller vNIC eth0 プロパティのスクリーンショット"]

. eth1 に手順 3 と 4 を繰り返し、アップリンクポートが eth1 に 1 に設定されていることを確認します。
+
image:express-c-series-c190-deploy_image16.png["Cisco Integrated Management Controller のvNIC一覧（eth0～eth3、MTU、アップリンクポート、VLAN設定を含む）のスクリーンショット"]
