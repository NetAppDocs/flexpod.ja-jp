...
image:express-c-series-c190-design_image4.png["SFP+モジュール用のUTA 2ポートを備えた2台のAFF C190コントローラの背面図を示す図"]

次の図に、従来の RJ-45 イーサネットケーブルを介した接続用の 10GBASE-T ポートを示します。

image:express-c-series-c190-design_image5.png["10GBASE-T RJ-45ポートを備えたAFF C190システムの背面パネルを示す図"]
...
AFF C190ハードウェアシステムの詳細については、 https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190ドキュメント"^]を参照してください。
...
image:express-c-series-c190-design_image6.png["複数の4KB論理ブロックを1つの4KB物理ブロックに圧縮した図"]
...
image:express-c-series-c190-design_image7.png["Cisco Nexus 31108PC-V スイッチの正面図（48 個の SFP+ ポートと 6 個の QSFP28 ポートを備える）"]
...
image:express-c-series-c190-design_image8.png["Cisco UCS C220 M5 ラックサーバー（デュアルドライブベイ付き、Cisco ブランディング）の正面図"]
...
image:express-c-series-c190-design_image9.png["Cisco UCS VIC 1457アダプター（SFP28ポート4個と冷却ファン搭載）のスクリーンショット"]
...
image:express-c-series-c190-design_image10.png["VMware ESXi 6.7 U2 ホスト上の FlexPod および iSCSI ブート vSwitches に接続された 4 つの vNIC を示す図"]
