...
+
image:express-c-series-aff220-deploy_image8.png["Cisco サーバーの起動画面のスクリーンショット。CIMC セットアップのために F8 キーを押すようユーザーに促している。"]
...
*** なし： [X]
+
image:express-c-series-aff220-deploy_image9.png["IPv4設定とNIC冗長性なしが選択された状態のCisco IMC NICプロパティのスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image10.png["Cisco IMC Configuration Utility の共通プロパティとポート設定を示すスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image11.png["「ブート順序の構成」が選択されたCisco Integrated Management Controller BIOS設定のスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image12.png["KVM-MAPPED-DVD、iSCSI-A、iSCSI-Bが有効になっている「Advanced Boot Order Configuration」のスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image13.png["PCIeスロット1とスロット2のオプションROMが無効になっているCIMC BIOS設定を示すスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image14.png["MTU 9000、VLAN 3439、トランク モード、およびPXEブートが有効になっているiSCSI-vNIC-Aの設定を示すスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image15.png["vNICsタブでiSCSI ブートプロパティが展開された状態でiSCSI-vNIC-Aが選択されていることを示すスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image16.png["Cisco UCS iSCSI ブートプロパティのスクリーンショット。イニシエータ名、IP アドレス、サブネットマスク、ゲートウェイの各フィールドが表示されています。"]
...
+
image:express-c-series-aff220-deploy_image17.png["プライマリおよびセカンダリ NetApp ターゲットを使用した iSCSI vNIC イニシエータ設定を示すスクリーンショット"]
...
+
image:express-c-series-aff220-deploy_image18.png["eth0、eth1、および2つのiSCSI vNICが表示されたCisco VIC vNICsタブのスクリーンショット"]

. eth0 を選択し、 Properties をクリックします。
. MTU を 9000 に設定します。[Save Changes] をクリックします。
+
image:express-c-series-aff220-deploy_image19.png["Cisco VIC eth0 vNIC のプロパティのスクリーンショット（MTU フィールドが 9000 に設定されている）"]

. eth1 について手順 3 と 4 を繰り返し、 eth1 のアップリンクポートが「 1 」に設定されていることを確認します。
+
image:express-c-series-aff220-deploy_image20.png["vNICs タブで eth0 と eth1 の MTU が 9000 に設定され、アップリンク ポートが 0 と 1 になっていることを示すスクリーンショット"]
