...
AFF A220ハードウェアシステムの詳細については、 https://www.netapp.com/aff-a-series/["AFF A-Series のホームページ"^]を参照してください。
...
image:express-c-series-aff220-design_image5.png["複数の4KB論理ブロックを1つの4KB物理ブロックに圧縮した図"]
...
image:express-c-series-aff220-design_image6.png["ディスクがルートパーティション、Controller 1パーティション、Controller 2パーティションに分割されていることを示す図"]

これらは、FlexPod Express ソリューションを補完するいくつかの主要な機能です。ONTAP 9.4 の追加機能の詳細については、 https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["ONTAP 9 データ管理ソフトウェアのデータシート"^]を参照してください。また、ONTAP 9.4 を含むように更新された NetApp http://docs.netapp.com/ontap-9/index.jsp["ONTAP 9 ドキュメンテーション・センター"^]も参照してください。
...
image:express-c-series-aff220-design_image7.png["Cisco Nexus 3172スイッチのネットワークポートを含む正面図を示すスクリーンショット"]
...
image:express-c-series-aff220-design_image8.png["Cisco UCS C220 M5 ラックサーバー（デュアルドライブベイ付き、Cisco ブランディング）の正面図"]
...
image:express-c-series-aff220-design_image9.png["デュアルQSFP+ポートと冷却ファンを備えたCisco UCS VIC 1387アダプターカード"]
...
image:express-c-series-aff220-design_image10.png["Cisco CVR-QSFP-SFP10G QSFP-to-SFP アダプタモジュールの写真"]
