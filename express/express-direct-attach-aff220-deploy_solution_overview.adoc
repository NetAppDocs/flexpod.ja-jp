...
image:express-direct-attach-aff220-deploy_image2.png["FlexPod Express、FlexPod Datacenter、および FlexPod Select ソリューションを比較した図"]
...
image:express-direct-attach-aff220-deploy_image3.png["管理、データ、IP、クラスタ インターコネクト、およびvPCピアネットワーク用のFlexPod Expressサーバ、Nexusスイッチ、およびAFFストレージケーブル接続を示す図"]
