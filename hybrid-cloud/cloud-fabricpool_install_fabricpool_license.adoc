...
image:cloud-fabricpool_image8.png["OnCommand System Manager の「ライセンスパッケージの追加」ダイアログに「ファイルの選択」ボタンと「追加」ボタンが表示されているスクリーンショット"]
...
image:cloud-fabricpool_image9.png["ONTAP System Manager のライセンス詳細のスクリーンショット（ FabricPool ライセンス容量 10 TB、現在の容量 0 Byte）"]
