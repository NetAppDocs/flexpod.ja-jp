...
Intersight のライセンスおよび各ライセンスでサポートされる機能の詳細については、 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["こちらをご覧ください"^]を参照してください。
...
Intersight AssistをIntersightに登録した後、Intersight Assist経由での登録オプションを使用してエンドポイントデバイスを登録できます。詳細については、 https://intersight.com/help/saas/getting_started/overview["はじめに"^]を参照してください。
