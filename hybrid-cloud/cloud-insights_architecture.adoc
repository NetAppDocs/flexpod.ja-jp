...
image:cloud-insights_image2.png["Cisco UCS、Nexus スイッチ、NetApp AFF A800 コントローラ、および MDS スイッチがネットワークリンクで相互接続されていることを示す図"]
...
* NetApp Digital Advisor に提供されたデータを使用して環境を分析し、ストレージシステムのリスク評価およびストレージ最適化に関する推奨事項を提供します。
