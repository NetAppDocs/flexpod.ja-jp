...
NOTE:  https://hwu.netapp.com/DetailViews/Home.aspx[][NetApp Hardware Universe^]で、FabricPoolでサポートされているプラットフォームの最新情報を参照してください。

* NetApp ONTAP Select [注記] NetAppでは、オールSSD FabricPoolローカル階層の使用を推奨しています。
* クラウド階層
+
