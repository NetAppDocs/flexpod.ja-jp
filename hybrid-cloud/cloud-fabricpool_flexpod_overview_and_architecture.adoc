...
image:cloud-fabricpool_image2.png["FlexPodストレージ、Cisco Nexus および MDS スイッチ、および Cisco UCS ファミリーと接続ガイダンスを示す図"]
...
image:cloud-fabricpool_image3.png["Cisco UCS、Nexus 93180YC-EX、AFF A300、およびMDS 9148S の接続を示す図"]
