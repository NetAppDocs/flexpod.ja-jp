...
image:flexpod-genomics-image6.png["Cisco UCS、Nexus、MDS、およびNetApp AFF A700の接続を伴うゲノミクス向けFlexPodを示す図"]

次の図は、 FlexPod のケーブル配線の詳細を示しています。

image:flexpod-genomics-image7.png["UCS、Nexus、NetApp AFF、およびMDSスイッチ間のFlexPod for Genomicsのケーブル接続を示す図"]
