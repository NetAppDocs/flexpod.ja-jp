...
詳細およびガイダンスについては、次の導入ドキュメントを参照してください。

* * FlexPod MetroCluster FC. * http://www.netapp.com/us/media/nva-0030-deploy.pdf["NVA-0030 - 導入： MetroCluster FlexPod FC を使用した データセンター"^]。
