...
ディスクシェルフとストレージ メディアの詳細については、以下の表の「ディスクシェルフおよびストレージ メディアの技術仕様」リンクを参照してください。

|===
| ディスクシェルフ | 技術仕様 


| DS224C .4+| https://www.netapp.com/data-storage/disk-shelves-storage-media/["ディスクシェルフおよびストレージ メディアの技術仕様"] 
...
| SupportEdge Premium 4 時間オンサイト—月数： 36 | ： cs -O2-4HR | https://www.netapp.com/pdf.html?item=/media/8745-supportedge-premium-product-description.pdf["NetApp SupportEdge Premium の略"^] 
|===