...
* *FlexPod Datacenter.*このプラットフォームは、ワークロードエンタープライズアプリケーション、仮想化、VDI、およびパブリッククラウドとプライベートクラウドに適した、大規模に拡張可能な仮想データセンターインフラです。FlexPod Datacenterには独自の仕様があり、それらは https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["FlexPod データセンター技術仕様"^]に記載されています。
