...
* *FlexPodデータセンター。*このプラットフォームは、企業ワークロードやアプリケーション、仮想化、AI/ML、データベース、SAP HANA、VDI、パブリッククラウドおよびプライベートクラウドに適した、拡張性の高いデータセンターインフラストラクチャです。FlexPodデータセンターには独自の仕様があり、 https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["FlexPod データセンター技術仕様"^]に記載されています。
