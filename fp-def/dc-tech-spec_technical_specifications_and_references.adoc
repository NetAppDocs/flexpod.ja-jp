...
| FAS9000 シリーズ | https://www.netapp.com/pdf.html?item=/media/8939-ds-3810.pdf["FAS9000 シリーズのデータシート"^] 


| FAS8700 シリーズ | https://www.netapp.com/pdf.html?item=/media/7819-ds-4020.pdf["FAS8700 シリーズのデータシート"^] 


| FAS8300 シリーズ | https://www.netapp.com/pdf.html?item=/media/7819-ds-4020.pdf["FAS8300 シリーズのデータシート"^] 


| FAS500f シリーズ | https://docs.netapp.com/us-en/ontap-systems/fas500f/index.html["FAS500f シリーズのデータシート"] 


| FAS2700 シリーズ | https://www.netapp.com/pdf.html?item=/media/8937-ds-3929.pdf["FAS2700 シリーズのデータシート"^] 
|===
...
最新モデルの NetApp AFF A シリーズストレージコントローラは、いずれも FlexPod で使用できます。詳細については https://www.netapp.com/media/7828-DS-3582-AFF-A-Series.pdf["AFF 技術仕様"^]、データシートおよびを参照して https://hwu.netapp.com/["NetApp Hardware Universe の略"^]ください。特定の AFF モデルの詳細については、次の表に示すプラットフォーム固有のドキュメントを参照してください。

|===
| コンポーネント | AFF A シリーズコントローラプラットフォームのドキュメント 


| NetApp AFF A800 | https://docs.netapp.com/us-en/ontap-systems/a800/install-setup.html["AFF A800 プラットフォームのドキュメント"] 


| NetApp AFF A700 | https://docs.netapp.com/us-en/ontap-systems/a700/install-setup.html["AFF A700 プラットフォームのドキュメント"] 


| NetApp AFF A700s | https://docs.netapp.com/us-en/ontap-systems/a700s/install-setup.html["AFF A700s プラットフォームのドキュメント"] 


| NetApp AFF A400 | https://docs.netapp.com/us-en/ontap-systems/a400/install-setup.html["AFF A400 プラットフォームのドキュメント"] 


| NetApp AFF A250 | https://docs.netapp.com/us-en/ontap-systems/a250/install-setup.html["AFF A250 プラットフォームマニュアル"] 
|===
...
NetAppディスクシェルフの技術仕様には、フォームファクタサイズ、エンクロージャあたりのドライブ数、およびシェルフI/Oモジュールが含まれます。これらの情報は、以下の表に記載されています。詳細については、 https://www.netapp.com/data-storage/disk-shelves-storage-media/["ネットアップのディスクシェルフとストレージメディア技術仕様"^]および https://hwu.netapp.com/["NetApp Hardware Universe の略"^]を参照してください。
