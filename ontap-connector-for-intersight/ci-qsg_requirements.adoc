...
NOTE: Cisco UCS コンピューティングコンポーネントおよび UCSM バージョンの最小要件については、 https://intersight.com/help/saas/supported_systems/overview["Cisco Intersightでサポートされるシステム"^]を参照してください。
...
各種ライセンスティアに含まれる機能の詳細については、 https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Infrastructure Servicesライセンス"^]を参照してください。
