...
Active IQ Unified Manager をインストールまたはアップグレードしていない場合は、インストールするかアップグレードしてください（最新バージョンを推奨します。現在 9.10P1 です）。手順については、を参照してください link:https://docs.netapp.com/us-en/active-iq-unified-manager/["NetApp Active IQ Unified Manager のドキュメント"]。
