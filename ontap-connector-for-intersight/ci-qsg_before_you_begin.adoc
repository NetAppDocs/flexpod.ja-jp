...
. Cisco Intersight Virtual Appliance を https://software.cisco.com/download/home/286319499/type/286323047/release/1.1.7-0.a["software.cisco.com"^]からダウンロードしてください。詳細については、 https://www.cisco.com/c/en/us/td/docs/unified_computing/Intersight/b_Cisco_Intersight_Appliance_Getting_Started_Guide/b_Cisco_Intersight_Appliance_Install_and_Upgrade_Guide_chapter_00.html["『 Intersight Appliance Install and Upgrade Guide 』を参照してください"^]を参照してください。
...
+
..  `https://<FQDN-of-your-appliance>`に移動して、アプライアンスのインストール後のセットアップを完了します。
+
